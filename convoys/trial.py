...
unit, groups_list1,groups_list2, (X,B,T)=get_arrays_for_double_hierachy(df, group1='category',group2='type', group_min_size1=1000,group_min_size2=1000,max_groups_1=-1, 
